...
def test_nba_scraper_input_type():
    """
    The function tests the nba_scraper function with various ranges of inputs to ensure the functionality is not
    broken.
...
def test_nba_scraper_output_df():
    """
    The function tests the nba_scraper function to check if it returns a DataFrame as output.
...
def test_nba_scraper_output_csv(tmp_path):
    """
    The function tests the nba_scraper function to check if the output csv scraped has the same dimensions 
    as the output dataframe returned from the function itself.
